...
import { IoIosPeople, IoMdMenu } from "react-icons/io";
...
export default function SideMenu() {
  ...
  return (
    <>
      {/* Mobile Brand & Menu */}
      <div className="flex sm:hidden items-center justify-between w-screen p-5 bg-[rgba(61,57,54,1)]">
      ...
      >
        <div>
          {/* Brand Logo */}
          <div className="hidden sm:flex items-center justify-between px-5 py-6">
            <img src="/images/icons/Brand-Name.png" />
          ...
          <ul className="mt-6 px-4 font-['Poppins'] text-gray-300 text-[14px] flex flex-col gap-3 cursor-default relative">
            ...
            <li className="rounded-xl bg-[#FFFFFF] h-[6vh] sm:h-[9vh] flex items-center gap-3 px-4 py-2 text-[14px] text-[#947550] leading-[100%] tracking-[-2%] z-0">
              <MdPeopleAlt size={20} />
              People
            </li>
        ...
        {/* Setting Button */}
        <div className="flex items-center sm:w-68 border border-[rgba(255,255,255,0.1)] rounded-2xl p-4 text-[14px] font-['Poppins'] m-4">
